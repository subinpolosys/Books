...
public class CreateVendorPage {
    ...
    private final By createdVendorNameField=By.xpath("//tbody/tr[1]/td[2]/div/div/p");
    
    public void navigateToNewVendor() {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(vendorMenuField)).click();
        wait.until(ExpectedConditions.elementToBeClickable(newVendorField)).click();
    }

    public void vendorDetails(String salutation, String firstName, String lastName, String companyName, String companyDisplayName,
